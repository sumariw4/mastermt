...
class MTConGroup
{
    ...
    public static function CreateDefault()
    {
        ...
        $group->TradeTransferMode    = MTEnTransferMode::TRANSFER_MODE_DISABLED;
        $group->MarginMode           = MTEnMarginMode::MARGIN_MODE_RETAIL;
        $group->MarginFreeProfitMode = MTEnMarginFreeProfitMode::FREE_MARGIN_PROFIT_PL;
        $group->LimitPositions       = 0;
        $group->Commissions          = array();
        $group->Symbols              = array();
        //---
        return $group;
    }
